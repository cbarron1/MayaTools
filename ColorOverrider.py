...
class Ui_ColorOverrider(object):
    def setupUi(self, ColorOverrider):
        ...
        self.centralWidget = QtGui.QWidget(ColorOverrider)
        ...
        self.redButton = QtGui.QPushButton(self.centralWidget)
        ...
        self.orangeButton = QtGui.QPushButton(self.centralWidget)
        ...
        self.ColorSlider = QtGui.QSlider(self.centralWidget)
        ...
        self.myText = QtGui.QLabel(self.centralWidget)
    ...
    def retranslateUi(self, ColorOverrider):
        ColorOverrider.setWindowTitle(QtGui.QApplication.translate("ColorOverrider", "Color Overrider", None, QtGui.QApplication.UnicodeUTF8))
        self.blueButton.setText(QtGui.QApplication.translate("ColorOverrider", "Blue", None, QtGui.QApplication.UnicodeUTF8))
        self.yellowButton.setText(QtGui.QApplication.translate("ColorOverrider", "Yellow", None, QtGui.QApplication.UnicodeUTF8))
        self.redButton.setText(QtGui.QApplication.translate("ColorOverrider", "Red", None, QtGui.QApplication.UnicodeUTF8))
        self.orangeButton.setText(QtGui.QApplication.translate("ColorOverrider", "Orange", None, QtGui.QApplication.UnicodeUTF8))
        self.myText.setText(QtGui.QApplication.translate("ColorOverrider", "Push below to confirm color", None, QtGui.QApplication.UnicodeUTF8))
        self.confirmButton.setText(QtGui.QApplication.translate("ColorOverrider", "Select Color", None, QtGui.QApplication.UnicodeUTF8))
